...
inactivity_dir <- "/mnt/EAS_shared/baboon/working/data/processed/2025/acc/inactivity"

# Create results directory if it doesn't exist
if (!dir.exists("/mnt/EAS_shared/baboon/working/data/processed/2025/acc/sleep_metrics")) {
  dir.create("/mnt/EAS_shared/baboon/working/data/processed/2025/acc/sleep_metrics")
}

# List all files in the data/inactivity directory
inactivity_files <- list.files(path = inactivity_dir, 
                               pattern = ".*", 
                               full.names = TRUE,
                               recursive = TRUE)
